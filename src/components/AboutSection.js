    ...
    <>
      <Row className='about-container' id='aboutMe'>
        ...
        <Col md={6} className='about-text-container'>
          ...
          <ScrollAnimation animateIn='fadeInRight' animateOut='fadeOutRight'>
            <p className='lead'>I would not define myself by the work I’ve done, I would define myself by the work I want to do. Skills can be taught, but personality and attitude towards your work is what I think the most essential. I prefer to keep learning, continue challenging myself, and do interesting things that matter.</p>
          </ScrollAnimation>
          <ScrollAnimation animateIn='fadeInRight' animateOut='fadeOutRight'>
